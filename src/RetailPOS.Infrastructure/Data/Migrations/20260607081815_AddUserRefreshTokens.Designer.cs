...
namespace RetailPOS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260607081815_AddUserRefreshTokens")]
            ...
            modelBuilder.Entity("RetailPOS.Core.Entities.UserWarehouseAssignment", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("i_x_user_warehouse_assignments_user_id");
                    ...
                    b.HasIndex("UserId", "WarehouseId")
                        .IsUnique()
                        .HasDatabaseName("i_x_user_warehouse_assignments_user_id_warehouse_id");
